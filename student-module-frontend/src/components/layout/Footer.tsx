      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          {[ 
            ...
            <div key={idx}>
              <h5 className="font-semibold mb-5">{col.title}</h5>
              <ul className="space-y-3">
                {col.links.map(link => (
                  <li key={link}>
                    <Link href="/construction" className="text-muted-foreground hover:text-primary transition-colors">
                      {link}
                    </Link>
                  </li>
                ))}
        ...
        <div className="border-t border-border/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} idpicker. All rights reserved.
          </div>
