    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-32 pb-20">
        ...
        >
          ...
          <h1 className="text-4xl font-bold mb-6">Partners Page Under Construction</h1>
          <p className="text-muted-foreground text-lg mb-8">
            We're building relationships with educational institutions and organizations. Stay tuned!
          </p>
          <Link 
            href="/"
